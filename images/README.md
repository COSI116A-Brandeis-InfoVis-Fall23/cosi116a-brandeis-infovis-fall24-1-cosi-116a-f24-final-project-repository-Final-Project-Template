...
`FigmaVisSketch.png` is a screenshot of our final visualization sketch linked in `index.html` creating using [Figma]

`handSketches.png` is a screenshot of our 3 handwritten visualization sketches linked in `index.html`

`finalVisLineChart.png` is a screenshot of our final map visualization linked in `index.html`

`finalVisMap.png` is a screenshot of our final line chart visualization linked in `index.html`

`finalVisScatterPlot.png` is a screenshot of our final scatterplot visualization linked in `index.html`
